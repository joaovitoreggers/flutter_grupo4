...
class _ItemPageState extends State<ItemPage> {
  ...
  late TipoItemModel tipoSelecionado;
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((timeStamp) {
      final param =
          ModalRoute.of(context)?.settings.arguments as TipoItemModel;
      setState(() {
        tipoSelecionado = TipoItemModel(
            id: param.id,
            descricao: param.descricao,
            prazoDevolucao: param.prazoDevolucao);
      });
    });
  }
                ...
                return GestureDetector(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  'Descrição de uso: ${itens[index].descUso}',
                  ...
                  onTap: () async {
                    await Navigator.of(context)
                        .popAndPushNamed('/reserva', arguments: itens[index]);
                  },
                );
              },
            ),
