...
class ReservaConsultaPage extends StatefulWidget {
  ...
  const ReservaConsultaPage({ super.key });
            ...
            return Scaffold(
              ...
              body: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  DateTime? dataReserva = DateTime.parse(locacoes[index].dataReserva!);

                  return GestureDetector(
                    child: Card(
                      elevation: 2,
                      color: (locacoes[index].dataLocacao != null && locacoes[index].dataLocacao!.isNotEmpty)
                              ?Colors.green[50]
                              :Colors.red[50],
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Text('${locacoes[index].nome}',
                                  style: TextStyle(
                            ...
                            Row(
                              children: [
                                Text('Item Nº ',
                                  ...
                                  fontSize: 16.0),),
                                Expanded(
                                  child: Text('${locacoes[index].idItem}',
                                  style: TextStyle(
                                    fontSize: 16.0, fontWeight: FontWeight.w700),),
                                ),
                              ],
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Text('${locacoes[index].descricao}',
                                  style: TextStyle(
                                    fontSize: 16.0, fontWeight: FontWeight.w700),),
                                ),
                              ],
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: locacoes[index].dataReserva != null ?
                                    Text(DateFormat("dd/MM/yyyy").format(dataReserva),
                                    style: TextStyle(
                                      fontSize: 16.0,
                                      color: Colors.black,
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: (locacoes[index].dataLocacao != null && locacoes[index].dataLocacao!.isNotEmpty) ?
                              Text('Aprovado',
                              style: TextStyle(
                                fontSize: 16.0,
                                color: Colors.green,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text('Locações não encontradas',
                        style: TextStyle(
                                fontSize: 14.0, fontWeight: FontWeight.w700),),
                      ),
                      const SizedBox(
